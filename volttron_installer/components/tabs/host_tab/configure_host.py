    ...
    return rx.form(
        form_view.form_view_wrapper(
            form_entry.form_entry(
                "Id",
                rx.input(
                    value=host_tab_content.host_entry.id,
                    on_change=lambda value: HostTab.update_host_detail(host_tab_content.tab_content_id, "id", value),
                    required=True,
                    name="host_id"
                ),
                required_entry=True
            ...
            form_entry.form_entry(
                "Ansible User", 
                rx.input(
                    value=host_tab_content.host_entry.ansible_user,
                    on_change=lambda value: HostTab.update_host_detail(host_tab_content.tab_content_id, "ansible_user", value),
                    required=True,
                    name="ansible_user"
                ),
                required_entry=True
            ...
            form_entry.form_entry(
                "Ansible Host",
                rx.input(
                    value=host_tab_content.host_entry.ansible_host,
                    on_change=lambda value: HostTab.update_host_detail(host_tab_content.tab_content_id, "ansible_host", value),
                    required=True,
                    name="ansible_host"
                ),
                required_entry=True
