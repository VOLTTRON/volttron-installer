...
class PlatformPageState(DriverManagementState):
    ...
    # Deployment progress variables moved to PlatformDeploymentState
    ...
    # Deployment methods moved to PlatformDeploymentState


    # Status methods moved to PlatformStatusState


    # Platform lifecycle methods moved to PlatformStatusState


    # Log methods moved to PlatformLogState
    ...
    # Agent handling methods moved to PlatformAgentState
